...
- [x] Define supplier entitlement commands, lifecycle controls, authorization roles, expiration rules, and audit events.
- [x] Implement the gRPC orchestration service with a health endpoint and LAN binding.
